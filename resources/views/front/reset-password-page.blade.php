                    ...
                    <div class="">
                        <div class="uk-card-default uk-card-small">
                            <div class="uk-card-body">
                                <h3 class="uk-card-title"> بازیابی کلمه ی رمز عبور برای {{$user->firstname}} {{$user->lastname}} </h3>
                            </div> <!-- form tabs -->
                            <div  class="uk-card-body uk-text-right">
                                <form class="uk-form-stacked" action="{{route('reset.password' , $user->reset_password_token)}}" method="POST">
                                    {{method_field('PUT')}}
                                    {{csrf_field()}}
                                    <div class="uk-margin">
