            ...
            <div class="uk-container-small">
                <div class="uk-card-default uk-card-small">
                    <div class="uk-card-header">
                        <h4 class="uk-card-title"> بازیابی رمز عبور برای اعضا </h4>
                    </div> <!-- form tabs -->
                    <div class="uk-card-body uk-text-right">
                        ...
                        <div class="uk-alert-danger" uk-alert>
                            <p> متأسفانه کاربری با این ایمیل شناسایی نشد </p>
                            <a class="uk-alert-close" uk-close></a>
                        </div> <!-- danger alert -->
                        <form class="uk-form-stacked" action="/reset/password/teacher">
                            <div class="uk-margin">
